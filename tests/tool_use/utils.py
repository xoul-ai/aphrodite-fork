...
CONFIGS: Dict[str, ServerConfig] = {
    ...
    "llama": {
        ...
        "arguments": [
            ...
            str(APHRODITE_PATH / "examples/chat_templates/llama_3.1_json_tool.jinja")  # noqa: E501
        ],
        "supports_parallel":
        False,
    },
    "llama3.2": {
        ...
        "arguments": [
            "--tool-call-parser", "llama3_json", "--chat-template",
            str(APHRODITE_PATH / "examples/chat_templates/llama_3.2_json_tool.jinja")  # noqa: E501
        ],
        "supports_parallel":
        False,
    },
