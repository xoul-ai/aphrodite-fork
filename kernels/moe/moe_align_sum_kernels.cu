  ...
  if (use_global_memory) {
    ...
    APHRODITE_DISPATCH_INTEGRAL_TYPES(
        topk_ids.scalar_type(), "moe_align_block_size_kernel", [&] {
          ...
          auto kernel =
              aphrodite::moe::moe_align_block_size_kernel<scalar_t, uint16_t>;
          AT_CUDA_CHECK(
    ...
    APHRODITE_DISPATCH_INTEGRAL_TYPES(
        topk_ids.scalar_type(), "moe_align_block_size_kernel", [&] {
          auto kernel =
              aphrodite::moe::moe_align_block_size_kernel<scalar_t, int32_t>;
          AT_CUDA_CHECK(
              APHRODITE_DevFuncAttribute_SET_MaxDynamicSharedMemorySize(
...
void sgl_moe_align_block_size(torch::Tensor topk_ids, int64_t num_experts,
  ...
  APHRODITE_DISPATCH_INTEGRAL_TYPES(
      topk_ids.scalar_type(), "sgl_moe_align_block_size_kernel", [&] {
        ...
        auto align_kernel =
            aphrodite::moe::sgl_moe_align_block_size_kernel<scalar_t>;
        ...
        auto sort_kernel = aphrodite::moe::sgl_moe_token_sort_kernel<scalar_t>;
