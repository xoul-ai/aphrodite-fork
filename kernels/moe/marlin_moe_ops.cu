...
torch::Tensor marlin_gemm_moe(
    ...
    aphrodite::ScalarTypeTorchPtr const& b_q_type, int64_t size_m,
    int64_t size_n, int64_t size_k, bool is_k_full, int64_t num_experts,
  ...
  TORCH_CHECK(APHRODITE_IMPLIES(!is_k_full, has_act_order),
