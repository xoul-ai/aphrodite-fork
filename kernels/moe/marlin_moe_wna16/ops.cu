...
MarlinFuncPtr get_marlin_kernel(const aphrodite::ScalarType q_type,
  ...
  GPTQ_GET_IF_M1(aphrodite::kU4B8, 8, 8, 256)
  GPTQ_GET_IF_M1(aphrodite::kU4B8, 8, 4, 128)

  GPTQ_GET_IF_M234(aphrodite::kU4B8, 16, 4, 256)
  GPTQ_GET_IF_M234(aphrodite::kU4B8, 8, 4, 128)

  GPTQ_GET_IF_M1(aphrodite::kU8B128, 8, 8, 256)
  GPTQ_GET_IF_M1(aphrodite::kU8B128, 8, 4, 128)

  GPTQ_GET_IF_M234(aphrodite::kU8B128, 16, 4, 256)
  GPTQ_GET_IF_M234(aphrodite::kU8B128, 8, 4, 128)

  AWQ_GET_IF_M1(aphrodite::kU4, 8, 8, 256)
  AWQ_GET_IF_M1(aphrodite::kU4, 8, 4, 128)

  AWQ_GET_IF_M234(aphrodite::kU4, 16, 4, 256)
  AWQ_GET_IF_M234(aphrodite::kU4, 8, 4, 128)
