...
The MooncakeStoreConnector transfers KV caches between prefill Aphrodite workers
(KV cache producer) and decode Aphrodite workers (KV cache consumer) using a
