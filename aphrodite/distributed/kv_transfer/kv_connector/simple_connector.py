...
class SimpleConnector(KVConnectorBase):
    ...
    def __init__(
        ...
        # In disaggregated prefill, the prefill Aphrodite only uses send pipe
        # and the decode Aphrodite only uses recv pipe
    ...
    def send_kv_caches_and_hidden_states(
        ...
        # query_lens contains new KV caches that are added to Aphrodite.
