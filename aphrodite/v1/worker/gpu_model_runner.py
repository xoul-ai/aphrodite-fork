...
if TYPE_CHECKING:
    from aphrodite.v1.core.scheduler import SchedulerOutput
...
class GPUModelRunner:
    ...
    def load_model(self) -> None:
        ...
        with DeviceMemoryProfiler() as m:  # noqa: SIM117
            with patch("aphrodite.modeling.layers.sampler.Sampler",
                       Sampler):
...
class InputBatch:
    ...
    def condense(self, empty_req_indices: List[int]) -> None:
        ...
        while empty_req_indices:
            ...
            # TODO: Optimize the copy of token_ids_cpu and
            # block_table_cpu.
