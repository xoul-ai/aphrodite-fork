...
from aphrodite.common.sampling_params import (BeamSearchParams,
                                              ...
                                              RequestOutputKind,
                                              SamplingParams)
from aphrodite.common.utils import (Counter, Device, deprecate_args,
                                    deprecate_kwargs, is_list_of)
...
from aphrodite.endpoints.score_utils import (_cosine_similarity,
                                             _validate_score_input_lens)
from aphrodite.endpoints.utils import _validate_truncation_size
from aphrodite.engine.aphrodite_engine import AphroditeEngine
from aphrodite.engine.args_tools import (EngineArgs, HfOverrides, PoolerConfig,
                                         TaskOption)
from aphrodite.inputs import (PromptType, SingletonPrompt, TextPrompt,
                              TokensPrompt)
from aphrodite.inputs.parse import is_token_prompt, parse_and_batch_prompt
        ...
        *,
        ...
        Args:
            ...
            text_2: The texts to pair with the query to form the input
                to the LLM. See :class:`~aphrodite.inputs.PromptType` for
