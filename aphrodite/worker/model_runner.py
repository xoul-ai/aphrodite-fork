...
class GPUModelRunnerBase(ModelRunnerBase[TModelInputForGPU]):
    ...
    def __init__(
        ...
        # ever prepare_model_inputs() call.
    ...
    def load_model(self) -> None:
        ...
        if self.lora_config:
            ...
            if supports_multimodal(self.model):
                logger.warning("Regarding multimodal models, Aphrodite "
                               "currently only supports adding LoRA to "
                               "language model.")
...
class CUDAGraphRunner(nn.Module):
    ...
    def capture(
        ...
        **kwargs,
        ...
        # Note one iteration is not enough for torch.compile(dynamic=True)
