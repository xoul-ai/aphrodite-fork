...
class EAGLE(nn.Module):
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str = ""):
        ...
        self.model = model_cls(aphrodite_config=aphrodite_config,
    ...
    def load_weights(self, weights: Iterable[Tuple[str, torch.Tensor]]):
        ...
        # https://huggingface.co/abhigoyal/EAGLE-LLaMA3-Instruct-8B-aphrodite
        ...
        if "lm_head.weight" in model_weights:
            ...
            # NOTE: initialize the placeholder for lm_head weight.
