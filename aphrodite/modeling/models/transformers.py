...
class TransformersModel(nn.Module):
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str = ""):
        ...
        cache_config: CacheConfig = aphrodite_config.cache_config
        device_config: DeviceConfig = aphrodite_config.device_config
        model_config: ModelConfig = aphrodite_config.model_config
        parallel_config: ParallelConfig = aphrodite_config.parallel_config
        quant_config: QuantizationConfig = aphrodite_config.quant_config
...
class TransformersForCausalLM(nn.Module, SupportsQuant, SupportsLoRA,
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str = ""):
        ...
        self.model = TransformersModel(aphrodite_config=aphrodite_config, prefix=prefix)
    ...
    @property
    def hf_to_aphrodite_mapper(self):
        prefix_mapper = {
            name: "model." + name
