...
@torch.library.custom_op("aphrodite::inplace_fused_experts",
...
@torch.library.custom_op("aphrodite::outplace_fused_experts", mutates_args=[])
...
def fused_experts(hidden_states: torch.Tensor,
    ...
    if inplace:
        torch.ops.aphrodite.inplace_fused_experts(hidden_states, w1, w2,
        ...
        return torch.ops.aphrodite.outplace_fused_experts(
