...
def rocm_aiter_fused_experts(hidden_states: torch.Tensor,
    ...
    if block_shape is not None and use_fp8_w8a8:
        ...
        return torch.ops.aphrodite.rocm_aiter_fmoe_fp8_blockscale_g1u1(
    ...
    # w8a8 per-tensor activation per-tensor weight
        ...
        return torch.ops.aphrodite.rocm_aiter_asm_moe(hidden_states=hidden_states,
                                                 w1=w1,
                                                 w2=w2,
    ...
    return torch.ops.aphrodite.rocm_aiter_ck_moe(hidden_states=hidden_states,
                                            w1=w1,
                                            w2=w2,
                                            topk_weights=topk_weights,
                                            topk_ids=topk_ids)
